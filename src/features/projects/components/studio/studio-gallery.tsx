...
export function StudioGallery({
	...
	// Most recent first
	const sortedAssets = useMemo(() => [...laneAssets].reverse(), [laneAssets]);
						...
						<div className="p-4 space-y-4">
							...
							<div className="space-y-3">
								...
								<MetadataRow
									icon={<Clock size={12} />}
									label="Generated"
									value={new Date(selectedAsset.createdAt).toLocaleString()}
								/>
								...
								{selectedAsset.batchId && (
									<MetadataRow
										label="Batch ID"
										value={selectedAsset.batchId.slice(0, 8)}
									/>
								)}
...
function MetadataRow({
	...
	return (
		<div className="flex items-start justify-between gap-2">
			...
			<span className="text-xs text-foreground text-right max-w-[180px] break-words">
				{value}
			</span>
		</div>
	);
